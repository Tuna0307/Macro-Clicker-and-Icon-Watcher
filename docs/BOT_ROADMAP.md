...
11. Verify exact intended fixed dispatch card is rechecked/clicked and busy teams are untouched. The missing Team 2 idle crop has been restored, automated validation covers all three cards, and a five-second post-dispatch state hold now prevents a transient blank queue from restarting Team 1 before Team 3; supervised Team 1 -> Team 2 -> Team 3 progression remains pending.
